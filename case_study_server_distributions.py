...
import numpy as np
import json
from case_study_festival_servers import Festival, run_festival, generate_bimodal_interarrival
...
output_file = "T6_case_study_servers.json"
...
#     # Store results in a JSON file
#     output_file = "case_study_distribution_servers.json"
#     with open(output_file, "w") as f:
